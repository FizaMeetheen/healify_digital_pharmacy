...
const Home = () => {
  const categories = [
    ...
    { name: "Mother and Baby Care", img: motherAndBaby },
    { name: "Eye Care Products", img: eyeCare },
    { name: "Cold and Cough Products", img: coughAndCold },
            ...
            {topMedicines.map((medicine, i) => (
              ...
              >
                <img
                  src={
                    medicine.image ||
                    `https://images.unsplash.com/photo-1588776814546-3e8e058f3e3e?random=${i}`
                  }
                  alt={medicine.name}
                  className="h-44 w-full object-cover brightness-110 hover:brightness-125 transition-all duration-700"
                />
