  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-white">
        ...
        {
          Medicine ?
            <div className="container mx-auto flex flex-col lg:flex-row gap-8 px-4 mt-22">


              <div className="flex justify-center lg:w-1/2">
                <div className=" rounded-xl p-5 shadow-xl flex justify-center">
                  <img
                    src={Medicine.image}
                    alt="product"
              ...
              <div className="lg:w-1/2 flex flex-col gap-2">
                ...
                <span className="bg-gray-100 w-50 text-gray-700 px-4 py-2 rounded-lg text-xl font-medium">
                  INR:  {Medicine.price}
                </span>
